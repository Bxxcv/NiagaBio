...
window.NBAdmin = (function () {
  ...
  const refs = {
    ...
    userRows: $('userRows'),
    inactiveUserRows: $('inactiveUserRows'),
    ...
    inactiveUserSearch: $('adminInactiveUserSearch'),
    inactiveStatusFilter: $('adminInactiveStatusFilter'),
    ...
    inactiveUserCountInfo: $('adminInactiveUserCountInfo'),
    ...
    resetReportsBtn: $('adminResetReportsBtn'),
    reportsResetNotice: $('adminReportsResetNotice'),
