document.addEventListener('DOMContentLoaded', async()=>{
  ...
  profileName.value=profile.display_name||''; profileUsername.value=profile.username||''; profileBio.value=profile.bio||''; profileWhatsApp.value=profile.whatsapp_number||''; avatarPreview.src=NB.asset(profile.avatar_url||'assets/img/logo.jpg');
